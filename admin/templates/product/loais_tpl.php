...
<table class="blue_table">
	...
	<tr>
        ...
        <td style="width:10%;"><a href="index.php?com=product&act=edit_item&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id=<?=$items[$i]['id']?>" style="text-decoration:none;"><?=$items[$i]['ten_vi']?></a></td>    
		...
		<td style="width:5%;"><a href="index.php?com=product&act=edit_item&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_catcat=<?=$items[$i]['id_catcat']?>&id=<?=$items[$i]['id']?>"><img src="media/images/edit.png" /></a></td>
