<?php 
			...
			$sql_tinl="select * from #_product where hienthi =1 and id_item='".$id."' order by id desc";
			$d->query($sql_tinl);	
			...
			$sql_tenmenucat="select * from #_product_item where id ='".$id."'";
...
<div id="content">
  <div class="breadcrumb">
    <div class="wr-page r"> 
    	...
    	<a href="tin-tuc-list/<?=$tenmenulistkhongdau?>-<?=$idmenulist?>.html" title="Trang chủ"><?=$tenmenulist?>&nbsp;&nbsp;></a>&nbsp;&nbsp;
    	<span><?=$tenmenucat?></span> </div>
    </div>
  </div>
