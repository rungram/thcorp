...
<div class="fshop-mainbox">
    <div class="fshop-lprod-top">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="fshop-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="danh-muc/<?=$result_laylist["tenkhongdau"]?>-<?=$result_laylist["id"]?>.html"><?=$result_laylist["ten_vi"]?></a></li>
                        <li><a href="danh-muc-cat/<?=$result_cat["tenkhongdau"]?>-<?=$result_cat["id"]?>.html"><?=$result_cat["ten_vi"]?></a></li>
                        <li class="active"><a href="danh-muc-item/<?=$result_item["tenkhongdau"]?>-<?=$result_item["id"]?>.html"><?=$result_item["ten_vi"]?></a></li>
                    </ol>
                </div>
        ...
        <div class="row fshop-lprod-fillter clearfix">
            <div class="fshop-lprod-fprodname"> <h1><?=$result_laylist["ten_vi"]?></h1> <span>(<?=$total_sp?> sản phẩm)</span></div>
