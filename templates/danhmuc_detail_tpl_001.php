    ...
    <div class="container-fluid"> 
      ...
      <div class="fshop-mainbox">
            ...
            <div class="col-md-6 col-xs-12">
              <div class="fshop-breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="active"><a href="danh-muc/<?=$result_laylist["tenkhongdau"]?>-<?=$result_laylist["id"]?>.html">
                    <?=$result_laylist["ten_vi"]?>
                    </a></li>
                </ol>
              </div>
            </div>
              ...
              <div class="fshop-lprod-slnews">
                <div class="input-group"><span class="input-group-addon fshop-lpslnews-title">Tin mới <i>›</i></span>
                  <div class="fshop-lpslnews-main">
                    ...
                    <a href="tin-tuc-detail/<?=$tin_chay[$i]["tenkhongdau"]?>-<?=$tin_chay[$i]["id"]?>.html" title="<?=$tin_chay[$i]["ten_vi"]?>" >
                    <?=($i+1).' -- '.$tin_chay[$i]["ten_vi"].' | '?>
                    </a>
                    <?php }?>
                    </marquee>
                  </div>
        ...
        <div class="row fshop-lprod-fillter clearfix">
          <div class="fshop-lprod-fprodname">
            <h1>
              <?=$result_laylist["ten_vi"]?>
            </h1>
            <span>(
        ...
        <div class="row fshop-lprod-bnbot">
          <ul class="clearfix">
        ...
        <div class="row fshop-lprod-main box-products">
          ...
          <div id="category-products" class="products" data-link="#/dien-thoai" data-page="2" style="position: relative; height: 1734px;">
            ...
            <div class="p-item cell-1" style="position: absolute; <?php if($result_spnam[$i]["tc_big"]==3) echo 'left: 33.3333%; top: 289px;' ;else echo 'left:66.6667%;top: 0px;'?>">
              <div class="p-badge"> <img src="upload/sanpham/<?php if($result_spnam[$i]["tc_big"]==1) echo $result_spnam[$i]["thumb"]; else echo $result_spnam[$i]["thumb"] ?>" alt="<?=$result_spnam[$i]["ten_vi"]?>"></div>
              <div class="p-item-bound"><a href="chi-tiet-san-pham/<?=$result_spnam[$i]['tenkhongdau']?>-<?=$result_spnam[$i]['id']?>.html" title="" class="p-link-prod"></a>
                <figure class="p-image"><span><a href="chi-tiet-san-pham/<?=$result_spnam[$i]['tenkhongdau']?>-<?=$result_spnam[$i]['id']?>.html"><img src="upload/sanpham/<?php if($result_spnam[$i]["tc_big"]==1) echo $result_spnam[$i]["thumb"]; else echo $result_spnam[$i]["thumb_tc"] ?>" alt="<?=$result_spnam[$i]["ten_vi"]?>"></a></span></figure>
                <div class="p-info">
                  <div class="p-top-info">
                    <div class="p-info-show">
                      <div class="p-name"><a href="chi-tiet-san-pham/<?=$result_spnam[$i]['tenkhongdau']?>-<?=$result_spnam[$i]['id']?>.html">
                        <h3>
                  ...
                  <div class="p-hide-info">
                    <div class="best-seller-order"> </div>
      ...
      <style>
.back-to-top {bottom: 150px !important;}.button-bottom {display: none;}
</style>
    </div>
  </div>
</div>
<div id="menuHeader"> <a id="m-nav"><i class="icons m-nav-list-icon"></i> </a> <a href="#/" class="logo"><img src="images/logo-black.png"></a>
  <div class="search-box">
    <form>
      <input class="search-text-box tab-keyword" placeholder="Bạn muốn tìm gì?" type="text">
      <button type="submit" class="submit search-button search-button-btn"><i class="glyphicon glyphicon-search"></i></button>
      <div class="asmr">
        <ul class="fshop-search-cate">
        </ul>
        <ul class="fshop-search-prod">
        </ul>
      </div>
    </form>
  </div>
</div>
<div class="modal fade" id="modal-call-me" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <div class="fshop-pucb-close b-close close-f-modal" data-dismiss="modal"><a onClick="ga('send', 'event', 'Tat Popup lay sdt sp bestseller mobile home page ', 'Tat Popup lay sdt sp bestseller mobile home page ', 'Tat Popup lay sdt sp bestseller mobile home page ')">&nbsp;</a></div>
        \ </div>
    </div>
  </div>
</div>
<div class="back-to-top display"> <a href="javascript:;"></a> </div>
