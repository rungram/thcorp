<?php 
 error_reporting(E_ALL & ~E_NOTICE & ~E_DEPRECATED); 
  ...
  $url =  addslashes($_POST['url']);
	...
	if($value==1)
	{
		$sql_tungdanhmuc="select * from #_product where hienthi =1 and id_cat='$id'  order by id desc ";
	}
	elseif($value==2)
	{
		$sql_tungdanhmuc="select * from #_product where hienthi =1 and id_cat='$id'  order by luotxem desc ";
	}
	else
	{
